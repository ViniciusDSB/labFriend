from statisticFunctions import Statistics
from statisticFunctions import Uncertainties
import math
...
print(64*"-")
resultados = Statistics(dados2, True, 1)
resultados._mostrarDados()
print(64*"-")
...
massaMedia = resultados.media
massaIncerteza = resultados.devMedPad
